import { videoViewData } from "@/public/contents";
import React from "react";

const ViedoView: React.FC = () => {
  return (
    <div className="mb-20">
      <section className="mb-10 h-[60vh] bg-[url('/images/video-bg.webp')] bg-cover px-3 pt-14 lg:mb-48">
